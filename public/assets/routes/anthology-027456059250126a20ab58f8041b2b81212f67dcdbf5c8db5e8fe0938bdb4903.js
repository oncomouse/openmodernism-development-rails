define('mixins/protected-route/ProtectedRouteMixin',[
	'lodash',
	'postal'
], function(
	_,
...
define('components/anthology/anthology',['jquery', 'lodash', 'react', 'postal', 'mixins/login-dependent/LoginDependentMixin', 'mixins/protected-route/ProtectedRouteMixin', 'components/document/short_view', 'components/utilities/modal', 'jquery-ui/sortable', 'postal.request-response'], function ($, _, React, postal, LoginDependentMixin, ProtectedRouteMixin, DocumentShortView, Modal) {
	var Anthology = React.createClass({
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(
					'section',
					{ id: "currentAnthology", className: "anthology col-md-10 center-block" },
					React.createElement(
						'hgroup',
						{ className: "anthology-metadata" },
						React.createElement('h1', { id: "anthology-title", dangerouslySetInnerHTML: { __html: this.props.model.get('title') } }),
						React.createElement('h2', { id: "anthology-author", dangerouslySetInnerHTML: { __html: 'by ' + this.props.model.get('user')['email'] } })
					),
					React.createElement(
						'p',
						{ className: "text-center", id: "AnthologyEditContainer" },
						React.createElement(AnthologyEditButton, { model: this.props.model, authorized: this.authorizedForRoute(), ref: "AnthologyEditButton" })
					),
					React.createElement(
						'ul',
						{ id: "AnthologyContent", className: "list-group" },
						renderedChildren
					)
				),
				React.createElement(
					Modal,
					{ title: "Save Changes?", ref: "AnthologyModal", 'static': true },
					React.createElement(
						'h2',
						null,
	...
	var AnthologyEditButton = React.createClass({
		displayName: 'AnthologyEditButton',
		...
		render: function () {
			...
			if (this.props.authorized) {
				content = React.createElement(
					'a',
					{ className: "btn btn-default btn-lg", id: "AnthologyEdit", href: "#", onClick: this.toggleEdit },
					'Edit This Anthology'
				);
			}
			return content;
