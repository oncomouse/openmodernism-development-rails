...
define('components/sidebar/sidebar',['react', 'bootstrap/affix'], function (React) {
	var Sidebar = React.createClass({
		...
		render: function () {
			return React.createElement(
				'aside',
				{ id: 'Sidebar', 'data-affix': this.props.affix },
				React.createElement(
					'div',
					{ className: 'sidebar' },
					React.createElement(
...
define('components/document/short_view',['lodash', 'react'], function (_, React) {
	var DocumentShortView = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement('a', { href: '#/document/' + this.props.model.id, 'data-id': this.props.model.id, className: this.props.className, dangerouslySetInnerHTML: { __html: this.props.model.get('metadata').to_s() } })
			);
		}
	});
...
define('components/anthology/current_anthology',['lodash', 'postal', 'react', 'mixins/login-dependent/LoginDependentMixin', 'components/document/short_view', 'components/utilities/modal', 'postal.request-response', 'jquery-ui/sortable'], function (_, postal, React, LoginDependentMixin, DocumentShortView, Modal) {
	var CurrentAnthology = React.createClass({
		displayName: 'CurrentAnthology',

		mixins: [LoginDependentMixin],
		...
		turnOffSortable: function (newOrder) {
			$('ul.sortable').sortable(newOrder ? 'disable' : 'cancel');
		},
		render: function () {
			var content;
			if (this.state.loginStatus) {
				content = React.createElement(CurrentAnthologyContent, { ref: "CurrentAnthologyContent", sidebar: this.props.sidebar, onSubmit: this.setCurrentAnthology, anthologyList: this.state.anthologyList, currentAnthology: this.state.currentAnthology });
			} else {
	...
	var CurrentAnthologyContent = React.createClass({
		displayName: 'CurrentAnthologyContent',
		...
		turnOnSortable: function () {
			$('ul.sortable').sortable({
				...
				cancel: _.map(JSON.parse(this.props.currentAnthology.get('toc')), function (x) {
					return '#DocumentsView li[data-id=' + x + ']';
				}).join(",")
			});
		},
			...
			if (this.props.currentAnthology != null) {
				if (this.props.sidebar) {
					var renderedChildren = _.map(this.props.currentAnthology.get('documents').models, function (element) {
						return React.createElement(DocumentShortView, { className: "list-group-item", model: element, key: JSON.stringify(element) });
					});
					content = React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ onClick: this.stopEditing, className: "btn btn-primary" },
								'Done Editing'
							)
						),
						React.createElement(
							'ul',
							{ className: "list-group sortable target", id: "CurrentAnthologyContent", ref: "CurrentAnthologyContentList" },
							renderedChildren
						),
						React.createElement(
							Modal,
							{ title: "Save Changes?", 'static': true, ref: "ConfirmSaveModal" },
							React.createElement(
								'h2',
								null,
								'Save Current Anthology?'
							),
							React.createElement(
								'p',
								{ className: "text-center" },
								React.createElement(
									'button',
									{ onClick: this.saveChanges, className: 'btn btn-primary btn-lg' },
									'Yes'
								),
								React.createElement(
									'button',
									{ onClick: this.cancelChanges, className: 'btn btn-default btn-lg' },
									'No'
								)
							)
						)
				...
				if (this.props.sidebar) {
					content = React.createElement(
						'form',
						{ onSubmit: this.props.onSubmit, ref: "CurrentAnthologyContentForm" },
						React.createElement(
							'h4',
							null,
							'Edit An Anthology'
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: "anthology_id" },
								'Anthology'
							),
							React.createElement(CurrentAnthologySelect, { anthologyList: this.props.anthologyList, ref: "CurrentAnthologySelect" })
						),
						React.createElement(
							'div',
							{ className: "form-group text-center" },
							React.createElement('input', { type: "submit", className: "btn btn-primary", value: "Edit This Anthology" })
						)
					);
				}
			}
	...
	var CurrentAnthologySelect = React.createClass({
		displayName: 'CurrentAnthologySelect',
		...
		render: function () {
			...
			if (this.props.anthologyList) {
				var rendered_content = _.map(this.props.anthologyList.models, function (element) {
					return React.createElement(
						'option',
						{ value: element.id, key: element.id },
						element.get('title')
					);
				});
				...
				content = React.createElement(
					'select',
					{ className: "form-control", name: "anthology[id]", id: "anthology_id" },
					rendered_content
				);
			}
...
define('components/sidebar/routes/anthologies',['jquery', 'lodash', 'react', 'postal', 'mixins/login-dependent/LoginDependentMixin', 'components/anthology/current_anthology'], function ($, _, React, postal, LoginDependentMixin, CurrentAnthology) {
	var SidebarAnthologies = React.createClass({
		...
		loggedIn: function () {
			return React.createElement(
				'div',
				null,
				React.createElement(CreateAnthologyForm, null),
				React.createElement(CurrentAnthology, { sidebar: true })
			);
		},
		loggedOut: function () {
			return React.createElement(
	...
	var CreateAnthologyForm = React.createClass({
		displayName: 'CreateAnthologyForm',
		...
		render: function () {
			return React.createElement(
				'form',
				{ onSubmit: this.handleSubmit, className: "create-anthology", acceptCharset: "UTF-8", 'data-remote': "true", method: "post" },
				...
				React.createElement(
					...
					React.createElement(
						'label',
						{ htmlFor: "anthology_title" },
						'Anthology Title'
					),
					React.createElement('input', { placeholder: "Title", className: "form-control", required: "required", type: "text", name: "anthology[title]", id: "anthology_title" })
				),
				React.createElement(
					'div',
					null,
...
define('components/anthology/anthologies',['lodash', 'react', 'postal', 'components/sidebar/sidebar', 'components/sidebar/routes/anthologies', 'components/utilities/modal'], function (_, React, postal, Sidebar, SidebarAnthologies, Modal) {
	var Anthologies = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					Sidebar,
					{ attach: true, title: "Anthologies List" },
					React.createElement(SidebarAnthologies, { collection: this.props.collection })
				),
				React.createElement(
					Modal,
					{ title: "Are You Sure?", 'static': true, ref: "ConfirmDeleteModal" },
					React.createElement(
						'h2',
						null,
						'Delete This Anthology?'
					),
					React.createElement(
						'p',
						{ className: "text-center" },
						React.createElement(
							'button',
							{ onClick: this.deleteAnthology, className: 'btn btn-primary btn-lg' },
							'Yes'
						),
						React.createElement(
							'button',
							{ onClick: this.cancelDeleteAnthology, className: 'btn btn-default btn-lg' },
							'No'
						)
					)
				)
	...
	var AnthologyShortView = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: '#/anthology/' + this.props.model.id },
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ href: "#", onClick: this.editThisDocument },
						'Add Documents'
					)
				),
				React.createElement(
					...
					React.createElement(
						'a',
						{ href: "#", 'data-id': this.props.model.id, onClick: this.deleteThisDocument },
						'Delete Anthology'
					)
				)
			);
