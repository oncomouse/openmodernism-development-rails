...
define('components/sidebar/routes/documents',['lodash', 'jquery', 'react', 'postal', 'components/anthology/current_anthology', 'mixins/login-dependent/LoginDependentMixin'], function (_, $, React, postal, CurrentAnthology, LoginDependentMixin) {
	var SidebarDocuments = React.createClass({
		...
		render: function () {
			var content;
			if (this.state.loginStatus) {
				content = React.createElement(CurrentAnthology, { sidebar: true });
			} else {
				content = React.createElement(
					'p',
					null,
...
define('components/document/documents',['lodash', 'react', 'postal', 'components/sidebar/sidebar', 'components/sidebar/routes/documents', 'components/document/short_view', 'jquery-ui/sortable'], function (_, React, postal, Sidebar, SidebarDocuments, DocumentShortView) {
	var Documents = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(DocumentList, { collection: this.props.collection, ref: "DocumentList" }),
				React.createElement(
					Sidebar,
					{ attach: true, title: "Documents List" },
					React.createElement(SidebarDocuments, { collection: this.props.collection })
				)
			);
		}
	});
